...
> **说明**：以上命令行用法属于原项目主程序（`weread_exporter`，基于 pyppeteer）。由于新版微信读书的反爬调整，该主程序已无法直接导出。本项目另有适配新版微信读书的**改进版抓取脚本与简易桌面 GUI**，见 [`platform/`](platform/) 及 [`platform/README.md`](platform/README.md)。
